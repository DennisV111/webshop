...
class ItemSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('books')->insert([
            ...
            'inventory_id'  => 5,
            'author'        => 'Matt Zhang',
            'description'   => 'How Nelly Saved Her Money: 52 Week Budgeting book. 8.5x11”. Budget your money monthly, weekly, daily for a year! Financial Planner and Organizer Journal : Lee, Annie: Amazon.sg: Books',
        ...
        DB::table('books')->insert([
            ...
            'inventory_id'  => 3,
            'author'        => 'Jennifer Jones',
            'description'   => 'Best Books on Color Theory. Here is my roundup of the best books on color theory for designers, graphic designers and artists! Let’s dive in. Interaction of Color: 50th Anniversary Edition. Color: A Natural History of the Palette. The Secret Lives of Color. Secret Language of Color.',
        ...
        DB::table('books')->insert([
            ...
            'inventory_id'  => 6,
            'author'        => 'Andrei Gaff',
            'description'   => 'Gifted Children. Nextory biedt meer dan 250.000 luisterboeken en e-books. Luister en lees zoveel je wilt. Online & Offline. Kinderboeken. Probeer 30 dagen gratis. Spanning. Misdaad en mysteriefictie. Read and listen unlimited. Cancel anytime.',
