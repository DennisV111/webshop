        ...
        <div>
            <nav class="navbar fixed-top navbar-expand-lg navbar-dark p-md-3">
                <div class="container-logoo">
                    <a class="navbar-brand navi-b" href="#">
                        <h2><span id="b">B</span>
                            <span id="book">
                ...
                <div class="icons-container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarScroll">
                        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll col-9"
                            style="--bs-scroll-height: 100px;">
                            <li class="nav-item">
                                <a class="nav-link h4" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                        height="25" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div id="category" class="category-carousel hidden-xs">
                        <div class="item">
                            <div class="image">
                                <img src="img/Background/cat1.jpg" alt="" class="img-responsive" />
                            </div>
                                                    ...
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html"><img
                                                                    src="img/Photography/Photography1.jpg" alt="" /></a>
                                                        </div>
                                                        <!-- /.image -->
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html"><img
                                                                    src="img/Photography/Photography2.jpg" alt="" /></a>
                                                        </div>
                                                        <!-- /.image -->
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html"><img
                                                                    src="img/Photography/Photography3.jpg" alt="" /></a>
                                                        </div>
                                                        <!-- /.image -->
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html"><img
                                                                    src="img/Photography/Photography4.jpg" alt="" /></a>
                                                        </div>
                                                        <!-- /.image -->
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html"><img
                                                                    src="img/Photography/Photography5.jpg" alt="" /></a>
                                                        </div>
                                                        <!-- /.image -->
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html"><img
                                                                    src="img/Photography/Photography6.jpg" alt="" /></a>
                                                        </div>
                                                        <!-- /.image -->
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html"><img
                                                                    src="img/Photography/Photography7.jpg" alt="" /></a>
                                                        </div>
                                                        <!-- /.image -->
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html"><img
                                                                    src="img/Photography/Photography8.jpg" alt="" /></a>
                                                        </div>
                                                        <!-- /.image -->
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="detail.html"><img
                                                                    src="img/Photography/Photography9.jpg" alt="" /></a>
                                                        </div>
                                                        <!-- /.image -->
